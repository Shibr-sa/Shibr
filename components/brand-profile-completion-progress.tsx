...
export function BrandProfileCompletionProgress({ showDetails = true }: { showDetails?: boolean }) {
  ...
  useEffect(() => {
    ...
    // Define all profile fields with their requirements for brand
    const fields: ProfileField[] = [
      ...
      {
        key: "brandName",
        label: t("settings.brand_data.brand_name"),
      ...
      },
      {
        ...
        label: profile.businessType === "freelancer"
          ? t("settings.brand_data.freelance_license")
          : t("settings.brand_data.commercial_reg"),
        value: profile.freelanceLicenseNumber || profile.commercialRegisterNumber,
        required: true,
        section: "brand-data"
      },
      {
      ...
      {
        key: "website",
        label: t("settings.brand_data.website"),
                ...
                {missingFields.map((field) => (
                  ...
                  >
                    ...
                    <Button
                      ...
                      asChild
                    >
                      <Link href={`/brand-dashboard/settings?tab=${getSectionFromField(field)}`}>
                        {t("settings.add_now")}
                        <ChevronRight className="h-3 w-3 ms-1" />
                      </Link>
                    </Button>
