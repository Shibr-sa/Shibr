                    ...
                    <div className="relative h-48 bg-muted group">
                      {allImages.length > 0 ? (
                        <>
                          ...
                          {hasMultipleImages && (
                            <>
                              <div className="absolute top-2 start-2 bg-black/70 text-white px-2 py-1 rounded text-xs">
                              ...
                              <button
                                ...
                                className="absolute start-2 top-1/2 -translate-y-1/2 h-8 w-8 rounded-full bg-white/90 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity"
                              >
                              ...
                              <button
                                ...
                                className="absolute end-2 top-1/2 -translate-y-1/2 h-8 w-8 rounded-full bg-white/90 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity"
                              >
