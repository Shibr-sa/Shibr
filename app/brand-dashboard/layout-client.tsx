...
import { Home, Package, ShoppingCart, Settings, ChevronUp, LogOut, ExternalLink, FileCheck } from "lucide-react"
...
const sidebarItems = [
  ...
  { title: "clearances.title", href: "/brand-dashboard/clearances", icon: FileCheck, pageTitle: "clearances.title" },
