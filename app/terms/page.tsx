                ...
                <div className="mt-8 pt-8 border-t">
                  ...
                  <div className={ `space-y-2 text-muted-foreground ${direction === "rtl" ? "text-right" : "text-left"}` }>
                    <p className={ direction === "rtl" ? "flex justify-end gap-2" : "" }>
                      { isArabic ? (
                        <>
                          <Link href="mailto:info@shibr.io" className="text-primary hover:underline">
                            info@shibr.io
                          </Link>
                    ...
                    <p className={ direction === "rtl" ? "flex justify-end gap-2" : "" }>
                      { isArabic ? (
                        <>
                          <Link href="tel:+966536412311" className="text-primary hover:underline" dir="ltr">
                            +966 53 641 2311
                          </Link>
                          <span>:الهاتف</span>
                        </>
                        ...
                        <>
                          <span>Phone: </span>
                          <Link href="tel:+966536412311" className="text-primary hover:underline">
                            +966 53 641 2311
                          </Link>
                        </>
                      ) }
