                ...
                <form onSubmit={ handleSubmit } className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <RadioGroup
                      ...
                      onValueChange={ (value) => setFormData(prev => ({ ...prev, subject: value as "general" | "support" | "business" | "complaint" })) }
                      ...
                      { subjects.map((subject) => (
                        <div key={ subject.value }>
                          ...
                          <Label
                            ...
                            className={ `flex items-center gap-2 rounded-lg border-2 border-muted bg-background p-4 hover:bg-muted/50 cursor-pointer peer-data-[state=checked]:border-primary ${direction === "rtl" ? "flex-row-reverse" : ""
                              }` }
                          >
                            { subject.icon }
                            { subject.label }
