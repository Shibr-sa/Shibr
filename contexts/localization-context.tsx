...
const translations = {
  ar: {
    ...
    "faq.q1": "هل شبر تأخذ عمولة على كل عملية؟",
    "faq.a1": "نعم ، شبر مجرد منصة وسيطة. الاتفاق المالي بالكامل بين صاحب المحل وصاحب المتجر، وشبر تأخذ نسبة بسيطة.",
  ...
  en: {
    ...
    "add_shelf.price_fee_notice": "A شبر fee will be added to the price",
    "add_shelf.shibr_percentage": "شبر Percentage",
    ...
    "add_shelf.platform_fee_notice": "A {fee}% شبر fee will be added to the price",
    ...
    "dashboard.monitor_performance_description":
      "Monitor your performance, display your shelves for rent, and start increasing your income with شبر.",
    ...
    // Stores Page
    "stores.title": "Registered Commercial Stores on شبر",
    "stores.description": "Comprehensive overview of store performance at شبر",
    ...
    "admin.settings.platform_name": "شبر Name",
    "admin.settings.platform_url": "شبر URL",
    "admin.settings.platform_description": "شبر Description",
    ...
    "settings.payment.platform_fee": "شبر Fee",
    ...
    "hero.description":
      "شبر is a technology platform that connects online stores with physical retail shops through displaying and renting dedicated shelf spaces inside stores, aiming to transform unused spaces into instant points of sale.",
    "hero.start_now": "Start Now",
    "hero.learn_more": "Learn More",
    
    // Features
    "features.title": "Our Features",
    "features.subtitle": "Discover how شبر helps you achieve your business goals",
    ...
    "features.empty_spaces.description": "If you have an unused shelf, wall, or corner, شبر helps you rent it out and generate monthly income or a percentage of sales easily.",
    ...
    "faq.subtitle": "Answers to the most common questions about شبر platform",
    "faq.q1": "Does شبر take a commission on every transaction?",
    "faq.a1": "Yes, شبر is just an intermediary platform. The financial agreement is entirely between the store owner and the merchant, and شبر takes a small percentage.",
    ...
    // Why Choose Section
    "why_choose.title": "Why choose شبر?",
    "why_choose.subtitle": "The platform that brings together physical and digital commerce in one place",
    "why_choose.description": "Whether you're a store owner looking to increase your income, or an online store wanting to reach customers in reality, شبر is designed to provide you with a smooth, flexible experience that preserves your rights from the first shelf to the first sale.",

    // Statistics
    "stats.why_choose": "Why choose",
    "stats.platform": "for the digital platform",
    "stats.description":
      "Physical and digital in one place, شبر platform includes more than 1000 merchants and more than 10000 diverse products and services in Saudi Arabia, and provides fast delivery service to all regions in Saudi Arabia.",
    ...
    "footer.description":
      "شبر is a technology platform that connects online stores and physical retail shops through displaying and renting dedicated shelf spaces inside stores, aiming to transform unused spaces into instant sales points.",
    ...
    "auth.select_account_type_description": "How do you want to use شبر platform?",
    ...
    "auth.platform_terms": "of شبر platform",
    "auth.error": "Error",
    ...
    "brand.dashboard.welcome_to_shelfy": "Welcome to شبر",
