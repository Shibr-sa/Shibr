...
const translations = {
  ar: {
    ...
    "auth.password_requirements": "كلمة المرور يجب أن تحتوي على:",
    "auth.password_min_length": "8 أحرف على الأقل",
    "auth.password_uppercase": "حرف كبير واحد",
    "auth.password_lowercase": "حرف صغير واحد",
    "auth.password_number": "رقم واحد",
    ...
    "auth.password_requirements.min_length": "٨ أحرف على الأقل",
    "auth.password_requirements.uppercase": "حرف كبير واحد على الأقل",
    "auth.password_requirements.lowercase": "حرف صغير واحد على الأقل",
    "auth.password_requirements.number": "رقم واحد على الأقل",
    ...
    "validation.password_min_length": "كلمة المرور يجب أن تكون 8 أحرف على الأقل",
    "validation.password_uppercase": "كلمة المرور يجب أن تحتوي على حرف كبير واحد على الأقل",
    "validation.password_lowercase": "كلمة المرور يجب أن تحتوي على حرف صغير واحد على الأقل",
  ...
  en: {
    ...
    "auth.password_min_length": "At least 8 characters",
    "auth.password_uppercase": "One uppercase letter",
    "auth.password_lowercase": "One lowercase letter",
    ...
    "auth.password_requirements.min_length": "At least 8 characters",
    "auth.password_requirements.uppercase": "At least one uppercase letter",
    "auth.password_requirements.lowercase": "At least one lowercase letter",
    "auth.password_requirements.number": "At least one number",
