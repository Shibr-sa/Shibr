...
const translations = {
  ar: {
    ...
    "add_shelf.discount_max_error": "النسبة يجب ألا تتجاوز 50%",
    ...
    // Rental Approvals Section
    "rentals.title": "موافقات الإيجار",
    "rentals.description": "مراجعة والموافقة على طلبات الإيجار من العلامات التجارية",
    "rentals.total_pending": "بانتظار الموافقة",
    "rentals.total_approved": "تمت الموافقة في هذه الفترة",
    "rentals.total_rejected": "تم الرفض في هذه الفترة",
    "rentals.pending_revenue": "الإيرادات المعلقة",
    "rentals.filter_all": "جميع الطلبات",
    "rentals.filter_pending": "بانتظار الموافقة",
    "rentals.filter_approved": "تمت الموافقة",
    "rentals.filter_rejected": "مرفوض",
    "rentals.search_placeholder": "ابحث عن علامة تجارية أو متجر أو رف...",
    "rentals.table.brand": "العلامة التجارية",
    "rentals.table.store": "المتجر",
    "rentals.table.shelf": "الرف",
    "rentals.table.duration": "المدة",
    "rentals.table.amount": "المبلغ الإجمالي",
    "rentals.table.products": "المنتجات",
    "rentals.table.status": "الحالة",
    "rentals.table.requested_date": "تاريخ الطلب",
    "rentals.table.actions": "الخيارات",
    "rentals.view_details": "عرض التفاصيل",
    "rentals.request_details": "تفاصيل طلب الإيجار",
    "rentals.brand_information": "معلومات العلامة التجارية",
    "rentals.store_information": "معلومات المتجر",
    "rentals.shelf_information": "معلومات الرف",
    "rentals.rental_period": "فترة الإيجار",
    "rentals.monthly_rent": "الإيجار الشهري",
    "rentals.total_amount": "المبلغ الإجمالي",
    "rentals.products_summary": "ملخص المنتجات",
    "rentals.product_count": "{count} منتج",
    "rentals.total_quantity": "الكمية الإجمالية: {qty}",
    "rentals.categories": "الفئات",
    "rentals.platform_commission": "عمولة المنصة",
    "rentals.commission_rate": "نسبة العمولة (%)",
    "rentals.commission_description": "حدد نسبة عمولة المنصة لهذا الإيجار (0-50%)",
    "rentals.commission_placeholder": "أدخل نسبة العمولة (مثال: 25)",
    "rentals.commission_invalid": "يجب أن تكون العمولة بين 0 و 50%",
    "rentals.rejection_reason": "سبب الرفض",
    "rentals.rejection_placeholder": "اشرح لماذا يتم رفض هذا الطلب...",
    "rentals.reason_required": "سبب الرفض مطلوب",
    "rentals.approve_request": "الموافقة على الطلب",
    "rentals.reject_request": "رفض الطلب",
    "rentals.approving": "جارٍ الموافقة...",
    "rentals.rejecting": "جارٍ الرفض...",
    "rentals.approve_success": "تمت الموافقة على الطلب بنجاح",
    "rentals.approve_error": "فشل في الموافقة على الطلب",
    "rentals.reject_success": "تم رفض الطلب بنجاح",
    "rentals.reject_error": "فشل في رفض الطلب",
    "rentals.no_requests": "لا توجد طلبات إيجار",
    "rentals.no_requests_description": "ستظهر طلبات الإيجار هنا عندما تقدمها العلامات التجارية",
    "rentals.no_results": "لم يتم العثور على طلبات",
    "rentals.try_different_filter": "حاول تعديل البحث أو الفلاتر",
    "rentals.clear_filters": "مسح الفلاتر",

    // Shipping Section
    "status.awaiting_shipment": "بانتظار الشحن",
    "status.shipment_sent": "تم الشحن",
    "shipping.submit_shipment": "إرسال تفاصيل الشحن",
    "shipping.carrier": "شركة الشحن",
    "shipping.tracking_number": "رقم التتبع",
    "shipping.expected_delivery": "تاريخ التسليم المتوقع",
    "shipping.shipping_notes": "ملاحظات الشحن",
    "shipping.select_carrier": "اختر شركة الشحن",
    "shipping.enter_tracking": "أدخل رقم التتبع",
    "shipping.carrier_required": "شركة الشحن مطلوبة",
    "shipping.tracking_required": "رقم التتبع مطلوب",
    "shipping.submitting": "جاري الإرسال...",
    "shipping.submitted_success": "تم إرسال تفاصيل الشحن بنجاح",
    "shipping.submission_error": "فشل في إرسال تفاصيل الشحن",
    "shipping.confirm_receipt": "تأكيد استلام الشحنة",
    "shipping.shipment_details": "تفاصيل الشحنة",
    "shipping.shipped_by": "تم الشحن بواسطة",
    "shipping.shipped_on": "تاريخ الشحن",
    "shipping.condition": "حالة المنتجات",
    "shipping.condition_good": "جيدة",
    "shipping.condition_damaged": "تالفة",
    "shipping.condition_missing": "منتجات ناقصة",
    "shipping.upload_photos": "رفع صور الإيصال (اختياري)",
    "shipping.confirmation_notes": "ملاحظات التأكيد",
    "shipping.confirming": "جاري التأكيد...",
    "shipping.confirmed_success": "تم تأكيد استلام الشحنة بنجاح. بدأت فترة الإيجار!",
    "shipping.confirmation_error": "فشل في تأكيد الاستلام",
    "shipping.select_condition": "اختر حالة المنتجات",
    "carriers.smsa": "سمسا",
    "carriers.aramex": "أرامكس",
    "carriers.fedex": "فيدكس",
    "carriers.dhl": "دي إتش إل",
    "carriers.ups": "يو بي إس",
    "carriers.naqel": "ناقل",
    "carriers.zajil": "زاجل",
    "carriers.other": "أخرى",
    ...
    // Admin Products on Shelves
    "admin.productsOnShelves.title": "المنتجات على الأرفف",
    "admin.productsOnShelves.description": "عرض جميع المنتجات النشطة المعروضة على الأرفف",
    "admin.productsOnShelves.exportCSV": "تصدير CSV",
    "admin.productsOnShelves.filters": "التصفية",
    "admin.productsOnShelves.search": "بحث",
    "admin.productsOnShelves.searchPlaceholder": "ابحث عن منتج، متجر أو ماركة...",
    "admin.productsOnShelves.filterByStore": "تصفية بالمتجر",
    "admin.productsOnShelves.filterByBrand": "تصفية بالماركة",
    "admin.productsOnShelves.filterByExpiry": "تصفية بالانتهاء",
    "admin.productsOnShelves.expiring3Days": "ينتهي خلال 3 أيام",
    "admin.productsOnShelves.expiring7Days": "ينتهي خلال 7 أيام",
    "admin.productsOnShelves.expiring30Days": "ينتهي خلال 30 يوم",
    "admin.productsOnShelves.showing": "عرض",
    "admin.productsOnShelves.products": "منتج",
    "admin.productsOnShelves.noProducts": "لا توجد منتجات",
    "admin.productsOnShelves.noProductsDescription": "لا توجد منتجات نشطة على الأرفف حالياً",
    "admin.productsOnShelves.productName": "اسم المنتج",
    "admin.productsOnShelves.brand": "الماركة",
    "admin.productsOnShelves.store": "المتجر",
    "admin.productsOnShelves.branch": "الفرع",
    "admin.productsOnShelves.initialQty": "الكمية الأولية",
    "admin.productsOnShelves.soldQty": "الكمية المباعة",
    "admin.productsOnShelves.remainingQty": "الكمية المتبقية",
    "admin.productsOnShelves.rentalEndDate": "تاريخ انتهاء الإيجار",
    "admin.productsOnShelves.daysUntilExpiry": "أيام حتى الانتهاء",
    "admin.productsOnShelves.expired": "منتهي",
    ...
    "settings.brand_data.business_type": "نوع النشاط التجاري",
    ...
    "settings.brand_data.profile_locked_title": "البيانات محمية",
    "settings.brand_data.profile_locked_description": "بياناتك التجارية الأساسية محمية ولا يمكن تعديلها. للتعديل، يرجى التواصل مع الدعم الفني.",
    "settings.profile_locked_error": "لا يمكن تعديل البيانات. الملف الشخصي محمي. يرجى التواصل مع الدعم الفني للتعديل.",
    "settings.locked_at_100": "تم حماية ملفك الشخصي بنسبة 100٪",
    "settings.complete_remaining": "أكمل الحقول المتبقية لحماية ملفك الشخصي",
    "settings.field_already_saved.name": "الاسم محفوظ بالفعل ولا يمكن تعديله",
    "settings.field_already_saved.email": "البريد الإلكتروني محفوظ بالفعل ولا يمكن تعديله",
    "settings.field_already_saved.phone": "رقم الهاتف محفوظ بالفعل ولا يمكن تعديله",
    "settings.field_already_saved.image": "الصورة محفوظة بالفعل ولا يمكن تعديلها",
    "settings.field_already_saved.brandName": "اسم العلامة التجارية محفوظ بالفعل ولا يمكن تعديله",
    "settings.field_already_saved.storeName": "اسم المتجر محفوظ بالفعل ولا يمكن تعديله",
    "settings.field_already_saved.businessCategory": "فئة النشاط التجاري محفوظة بالفعل ولا يمكن تعديلها",
    "settings.field_already_saved.businessType": "نوع النشاط التجاري محفوظ بالفعل ولا يمكن تعديله",
    "settings.field_already_saved.commercialRegisterNumber": "رقم السجل التجاري محفوظ بالفعل ولا يمكن تعديله",
    "settings.field_already_saved.commercialRegisterDocument": "وثيقة السجل التجاري محفوظة بالفعل ولا يمكن تعديلها",
    "settings.field_already_saved.freelanceLicenseNumber": "رقم وثيقة العمل الحر محفوظ بالفعل ولا يمكن تعديله",
    "settings.field_already_saved.freelanceLicenseDocument": "ملف وثيقة العمل الحر محفوظ بالفعل ولا يمكن تعديله",
    "settings.field_already_saved.website": "الموقع الإلكتروني محفوظ بالفعل ولا يمكن تعديله",
    ...
    "settings.brand_data.freelance_license": "رقم وثيقة العمل الحر",
    "settings.brand_data.freelance_license_document": "ملف وثيقة العمل الحر",
    ...
    // Stores Section (Landing Page)
    "landing.stores_title": "لأصحاب المحلات التجارية استفيد من كل مساحة عندك… شاركنا تفاصيلها ووسع دخلك",
    "landing.stores_description": "لأن كل شبر هو فرصة، استثمر مساحتك المتاحة وشاركها كنقاط بيع، عرّفنا على مكانك وزودنا بمعلوماته واكسب ربح إضافي بكل يسر وسهولة.",
    ...
    "orders.brand_owner": "صاحب العلامة التجارية",
    ...
    "brand.dashboard.confirm_delete_product_description": "سيتم حذف هذا المنتج نهائياً. هذا الإجراء لا يمكن التراجع عنه.",
    ...
    "status.pending_admin_approval": "بانتظار موافقة الإدارة",
    ...
    // Clearances (B3.1)
    "clearances.title": "التسويات",
    "clearances.description": "إدارة التسويات والمستحقات بعد انتهاء الإيجار",
    "clearances.empty": "لا توجد تسويات",
    "clearances.noResults": "لا توجد تسويات مطابقة للبحث",
    "clearances.searchPlaceholder": "ابحث باسم المتجر...",
    "clearances.viewDetails": "عرض التفاصيل",
    "clearances.page": "صفحة",
    "clearances.of": "من",
    "clearances.stats.total": "إجمالي التسويات",
    "clearances.stats.active": "نشطة",
    "clearances.stats.closed": "مغلقة",
    "clearances.stats.revenue": "إجمالي الإيرادات",
    "clearances.filter.all": "الكل",
    "clearances.filter.active": "نشطة",
    "clearances.filter.closed": "مغلقة",
    "clearances.table.rentalId": "رقم الإيجار",
    "clearances.table.store": "المتجر",
    "clearances.table.period": "الفترة",
    "clearances.table.status": "الحالة",
    "clearances.table.settlement": "التسوية",
    "clearances.table.actions": "الإجراءات",
    "clearances.status.unknown": "غير معروف",
    "clearances.status.not_started": "لم تبدأ",
    "clearances.status.pending_inventory_check": "بانتظار جرد المخزون",
    "clearances.status.pending_return_shipment": "بانتظار الإرجاع",
    "clearances.status.return_shipped": "تم شحن الإرجاع",
    "clearances.status.return_received": "تم استلام الإرجاع",
    "clearances.status.pending_settlement": "بانتظار التسوية",
    "clearances.status.settlement_approved": "تمت الموافقة على التسوية",
    "clearances.status.payment_completed": "تم الدفع",
    "clearances.status.closed": "مغلقة",
    "clearances.inventory.title": "مطابقة المخزون",
    "clearances.inventory.empty": "لا توجد بيانات مخزون متاحة",
    "clearances.inventory.product": "المنتج",
    "clearances.inventory.initial": "البداية",
    "clearances.inventory.sold": "تم البيع",
    "clearances.inventory.remaining": "المتبقي",
    "clearances.inventory.salesValue": "قيمة المبيعات (شاملة ض.ق.م)",
    "clearances.inventory.totals": "الإجمالي",
    "clearances.settlement.title": "التسوية المالية",
    "clearances.settlement.notCalculated": "لم يتم حساب التسوية بعد",
    "clearances.settlement.totalSales": "إجمالي المبيعات (قبل الضريبة)",
    "clearances.settlement.vat": "ضريبة القيمة المضافة",
    "clearances.settlement.totalWithTax": "الإجمالي مع الضريبة",
    "clearances.settlement.commissions": "العمولات",
    "clearances.settlement.platformCommission": "عمولة المنصة",
    "clearances.settlement.storeCommission": "عمولة المتجر",
    "clearances.settlement.brandRevenue": "إيرادات العلامة التجارية",
    "clearances.settlement.salesRevenue": "إيرادات المبيعات",
    "clearances.settlement.returnInventory": "المخزون المرتجع",
    "clearances.settlement.returnedUnits": "الوحدات المرتجعة",
    "clearances.settlement.units": "وحدة",
    "clearances.settlement.returnValue": "قيمة الإرجاع",
    "clearances.settlement.totalBrandAmount": "المبلغ الإجمالي للعلامة التجارية",
    "clearances.settlement.note": "المبلغ يشمل إيرادات المبيعات بعد خصم العمولات",
    "clearances.returnReceipt.title": "تأكيد استلام الإرجاع",
    "clearances.returnReceipt.description": "أكد أنك استلمت المنتجات المرتجعة",
    "clearances.returnReceipt.condition": "حالة المنتجات",
    "clearances.returnReceipt.selectCondition": "اختر الحالة",
    "clearances.returnReceipt.conditionGood": "جيدة",
    "clearances.returnReceipt.conditionDamaged": "تالفة",
    "clearances.returnReceipt.conditionPartial": "جزئية",
    "clearances.returnReceipt.notes": "ملاحظات",
    "clearances.returnReceipt.notesPlaceholder": "أي ملاحظات إضافية عن المنتجات المرتجعة...",
    "clearances.returnReceipt.confirm": "تأكيد الاستلام",
    "clearances.returnReceipt.conditionRequired": "يرجى اختيار حالة المنتجات",
    "clearances.returnReceipt.success": "تم تأكيد استلام الإرجاع بنجاح",
    "clearances.returnReceipt.error": "فشل تأكيد استلام الإرجاع",
    "clearances.returnShipping.title": "شحن الإرجاع",
    "clearances.returnShipping.notShipped": "لم يتم شحن المنتجات من المتجر بعد",
    "clearances.returnShipping.received": "تم الاستلام",
    "clearances.returnShipping.inTransit": "قيد الشحن",
    "clearances.returnShipping.carrier": "شركة الشحن",
    "clearances.returnShipping.trackingNumber": "رقم التتبع",
    "clearances.returnShipping.shippedDate": "تاريخ الشحن",
    "clearances.returnShipping.expectedDelivery": "التسليم المتوقع",
    "clearances.returnShipping.storeNotes": "ملاحظات المتجر",
    "clearances.returnShipping.receiptConfirmed": "تم تأكيد الاستلام",
    "clearances.returnShipping.receivedDate": "تاريخ الاستلام",
    "clearances.returnShipping.condition": "الحالة",
    "clearances.returnShipping.confirmationNotes": "ملاحظات التأكيد",
    "clearances.document.title": "وثيقة التسوية",
    "clearances.document.description": "تحميل وثيقة التسوية الكاملة",
    "clearances.document.ready": "الوثيقة جاهزة للتحميل",
    "clearances.document.download": "تحميل الوثيقة",
    "clearances.document.notReady": "سيتم إنشاء الوثيقة عند اكتمال التسوية",
    "clearances.document.notGenerated": "لم يتم إنشاء الوثيقة بعد",
    "clearances.document.downloadSuccess": "تم تحميل الوثيقة بنجاح",
    "clearances.document.downloadError": "فشل تحميل الوثيقة",
    "clearances.details.title": "تفاصيل التسوية",
    "clearances.details.subtitle": "تسوية للإيجار",
    "clearances.details.rentalSummary": "ملخص الإيجار",
    "clearances.details.rentalPeriod": "فترة الإيجار",
    "clearances.details.rentalCost": "التكلفة الشهرية",
    "clearances.details.totalPaid": "المبلغ المدفوع",

    // Clearances - Quick Info (B3.4)
    "clearances.quickInfo.title": "التسوية",
    "clearances.quickInfo.settlement": "مبلغ التسوية",
    "clearances.quickInfo.payout": "مستحقاتك",
    "clearances.quickInfo.viewDetails": "عرض التسوية الكاملة",

    // Clearances - Store Specific (B3.2)
    "clearances.store.description": "تتبع التسويات واستلام عمولات المبيعات",
    "clearances.store.stats.pendingPayouts": "مدفوعات معلقة",
    "clearances.store.stats.completedPayouts": "مدفوعات مكتملة",
    "clearances.store.searchPlaceholder": "ابحث باسم العلامة التجارية...",
    "clearances.store.table.brand": "العلامة التجارية",
    "clearances.store.table.payout": "المستحقات",
    "clearances.payout.title": "عمولتك من المبيعات",
    "clearances.payout.storeCommission": "عمولتك",
    "clearances.payout.commissionRate": "نسبة العمولة",
    "clearances.payout.platformCommission": "عمولة المنصة",
    "clearances.payout.totalPayout": "إجمالي المستحقات",
    "clearances.payout.note": "سيتم تحويل المبلغ إلى حسابك البنكي المسجل",
    "clearances.storeReturnShipping.title": "شحن الإرجاع للعلامة التجارية",
    "clearances.storeReturnShipping.description": "شحن المنتجات غير المباعة للعلامة التجارية",
    "clearances.storeReturnShipping.notesPlaceholder": "أي ملاحظات عن شحنة الإرجاع...",
    "clearances.storeReturnShipping.submit": "إرسال بيانات الشحن",
    "clearances.storeReturnShipping.success": "تم إرسال بيانات الإرجاع بنجاح",
    "clearances.storeReturnShipping.error": "فشل إرسال بيانات الإرجاع",
    "clearances.payoutTracker.title": "حالة الدفع",
    "clearances.payoutTracker.noPayments": "لا توجد سجلات دفع بعد",
    "clearances.payoutTracker.completed": "مكتمل",
    "clearances.payoutTracker.processing": "قيد المعالجة",
    "clearances.payoutTracker.failed": "فشل",
    "clearances.payoutTracker.pending": "معلق",
    "clearances.payoutTracker.payoutAmount": "مبلغ الدفع",
    "clearances.payoutTracker.createdDate": "تاريخ الإنشاء",
    "clearances.payoutTracker.completedDate": "تاريخ الاكتمال",
    "clearances.payoutTracker.viewDetails": "عرض التفاصيل",
    "clearances.payoutTracker.netPayout": "صافي المبلغ",
    "clearances.payoutTracker.pendingNote": "عادة ما تكتمل التحويلات المعلقة خلال 3-5 أيام عمل",

    // Clearances - Admin Specific (B3.3)
    "clearances.admin.title": "إدارة التسويات",
    "clearances.admin.description": "الإشراف على جميع التسويات والموافقة على المستحقات وإدارة المدفوعات",
    "clearances.admin.stats.pendingApproval": "بانتظار الموافقة",
    "clearances.admin.stats.completed": "مكتملة",
    "clearances.admin.stats.salesVolume": "إجمالي حجم المبيعات",
    "clearances.admin.filter.status": "تصفية حسب الحالة",
    "clearances.admin.filter.pendingApprovalOnly": "إظهار المعلقة فقط",
    "clearances.admin.searchPlaceholder": "ابحث باسم العلامة التجارية أو المتجر...",
    "clearances.admin.table.brandStore": "العلامة التجارية ← المتجر",
    "clearances.admin.table.settlement": "تفاصيل التسوية",
    "clearances.admin.needsApproval": "تحتاج موافقة",
    "clearances.admin.platform": "المنصة",
    "clearances.admin.store": "المتجر",
    "clearances.admin.brand": "العلامة التجارية",
    "clearances.admin.details.title": "نظرة عامة على التسوية",
    "clearances.admin.initialShipping": "الشحن الأولي (العلامة التجارية → المتجر)",
    "clearances.approval.title": "الموافقة على التسوية",
    "clearances.approval.description": "مراجعة والموافقة على التسوية المحسوبة",
    "clearances.approval.pending": "بانتظار الموافقة",
    "clearances.approval.approved": "تمت الموافقة",
    "clearances.approval.approvedOn": "تمت الموافقة في",
    "clearances.approval.platformCommission": "عمولة المنصة",
    "clearances.approval.storePayout": "مستحقات المتجر",
    "clearances.approval.brandRevenue": "إيرادات العلامة التجارية",
    "clearances.approval.totalSales": "إجمالي المبيعات",
    "clearances.approval.approve": "الموافقة على التسوية",
    "clearances.approval.confirmTitle": "الموافقة على التسوية؟",
    "clearances.approval.confirmDescription": "سيتم الموافقة على حساب التسوية وبدء عملية دفع المستحقات للمتجر:",
    "clearances.approval.success": "تمت الموافقة على التسوية بنجاح",
    "clearances.approval.error": "فشلت الموافقة على التسوية",
    "clearances.receiptUpload.title": "إيصال تحويل الدفع",
    "clearances.receiptUpload.description": "رفع إثبات التحويل للمتجر",
    "clearances.receiptUpload.file": "ملف الإيصال",
    "clearances.receiptUpload.notes": "ملاحظات مرجعية",
    "clearances.receiptUpload.notesPlaceholder": "رقم مرجع التحويل أو ملاحظات...",
    "clearances.receiptUpload.upload": "رفع الإيصال",
    "clearances.receiptUpload.uploaded": "تم الرفع",
    "clearances.receiptUpload.view": "عرض الإيصال",
    "clearances.receiptUpload.fileRequired": "يرجى اختيار ملف",
    "clearances.receiptUpload.invalidFileType": "يُسمح فقط بملفات PDF والصور",
    "clearances.receiptUpload.fileTooLarge": "يجب أن يكون حجم الملف أقل من 5 ميجابايت",
    "clearances.receiptUpload.success": "تم رفع الإيصال بنجاح",
    "clearances.receiptUpload.error": "فشل رفع الإيصال",
    "clearances.statusManagement.title": "تجاوز الحالة يدوياً",
    "clearances.statusManagement.warning": "⚠️ استخدم بحذر - التجاوز اليدوي يتجاوز سير العمل الطبيعي",
    "clearances.statusManagement.currentStatus": "الحالة الحالية",
    "clearances.statusManagement.newStatus": "الحالة الجديدة",
    "clearances.statusManagement.selectStatus": "اختر الحالة الجديدة",
    "clearances.statusManagement.reason": "سبب التجاوز",
    "clearances.statusManagement.reasonPlaceholder": "لماذا هذا التغيير اليدوي مطلوب؟",
    "clearances.statusManagement.notes": "ملاحظات إضافية",
    "clearances.statusManagement.notesPlaceholder": "أي سياق إضافي...",
    "clearances.statusManagement.updateStatus": "تحديث الحالة",
    "clearances.statusManagement.confirmTitle": "تأكيد التغيير اليدوي للحالة",
    "clearances.statusManagement.confirmDescription": "هل أنت متأكد من تغيير الحالة يدوياً؟",
    "clearances.statusManagement.from": "من",
    "clearances.statusManagement.to": "إلى",
    "clearances.statusManagement.reasonRequired": "يرجى تقديم سبب لتغيير الحالة",
    "clearances.statusManagement.success": "تم تحديث الحالة بنجاح",
    "clearances.statusManagement.error": "فشل تحديث الحالة",
  },
  en: {
    // Common
    "common.shibr": "Shibr",
    ...
    "add_shelf.discount_max_error": "Percentage must not exceed 50%",
    ...
    // Rental Approvals Section
    "rentals.title": "Rental Approvals",
    "rentals.description": "Review and approve rental requests from brands",
    "rentals.total_pending": "Pending Approval",
    "rentals.total_approved": "Approved This Period",
    "rentals.total_rejected": "Rejected This Period",
    "rentals.pending_revenue": "Pending Revenue",
    "rentals.filter_all": "All Requests",
    "rentals.filter_pending": "Awaiting Approval",
    "rentals.filter_approved": "Approved",
    "rentals.filter_rejected": "Rejected",
    "rentals.search_placeholder": "Search by brand, store, or shelf...",
    "rentals.table.brand": "Brand",
    "rentals.table.store": "Store",
    "rentals.table.shelf": "Shelf",
    "rentals.table.duration": "Duration",
    "rentals.table.amount": "Total Amount",
    "rentals.table.products": "Products",
    "rentals.table.status": "Status",
    "rentals.table.requested_date": "Requested",
    "rentals.table.actions": "Actions",
    "rentals.view_details": "View Details",
    "rentals.request_details": "Rental Request Details",
    "rentals.brand_information": "Brand Information",
    "rentals.store_information": "Store Information",
    "rentals.shelf_information": "Shelf Information",
    "rentals.rental_period": "Rental Period",
    "rentals.monthly_rent": "Monthly Rent",
    "rentals.total_amount": "Total Amount",
    "rentals.products_summary": "Products Summary",
    "rentals.product_count": "{count} product(s)",
    "rentals.total_quantity": "Total Qty: {qty}",
    "rentals.categories": "Categories",
    "rentals.platform_commission": "Platform Commission",
    "rentals.commission_rate": "Commission Rate (%)",
    "rentals.commission_description": "Set the platform commission percentage for this rental (0-50%)",
    "rentals.commission_placeholder": "Enter commission rate (e.g., 25)",
    "rentals.commission_invalid": "Commission must be between 0 and 50%",
    "rentals.rejection_reason": "Rejection Reason",
    "rentals.rejection_placeholder": "Explain why this request is being rejected...",
    "rentals.reason_required": "Rejection reason is required",
    "rentals.approve_request": "Approve Request",
    "rentals.reject_request": "Reject Request",
    "rentals.approving": "Approving...",
    "rentals.rejecting": "Rejecting...",
    "rentals.approve_success": "Request approved successfully",
    "rentals.approve_error": "Failed to approve request",
    "rentals.reject_success": "Request rejected successfully",
    "rentals.reject_error": "Failed to reject request",
    "rentals.no_requests": "No rental requests",
    "rentals.no_requests_description": "Rental requests will appear here when brands submit them",
    "rentals.no_results": "No requests found",
    "rentals.try_different_filter": "Try adjusting your search or filters",
    "rentals.clear_filters": "Clear Filters",

    // Shipping Section
    "status.awaiting_shipment": "Awaiting Shipment",
    "status.shipment_sent": "Shipment Sent",
    "shipping.submit_shipment": "Submit Shipment Details",
    "shipping.carrier": "Shipping Carrier",
    "shipping.tracking_number": "Tracking Number",
    "shipping.expected_delivery": "Expected Delivery Date",
    "shipping.shipping_notes": "Shipping Notes",
    "shipping.select_carrier": "Select Carrier",
    "shipping.enter_tracking": "Enter Tracking Number",
    "shipping.carrier_required": "Carrier is required",
    "shipping.tracking_required": "Tracking number is required",
    "shipping.submitting": "Submitting...",
    "shipping.submitted_success": "Shipment details submitted successfully",
    "shipping.submission_error": "Failed to submit shipment details",
    "shipping.confirm_receipt": "Confirm Receipt",
    "shipping.shipment_details": "Shipment Details",
    "shipping.shipped_by": "Shipped via",
    "shipping.shipped_on": "Shipped on",
    "shipping.condition": "Product Condition",
    "shipping.condition_good": "Good",
    "shipping.condition_damaged": "Damaged",
    "shipping.condition_missing": "Missing Items",
    "shipping.upload_photos": "Upload Receipt Photos (Optional)",
    "shipping.confirmation_notes": "Confirmation Notes",
    "shipping.confirming": "Confirming...",
    "shipping.confirmed_success": "Receipt confirmed successfully. Rental period has begun!",
    "shipping.confirmation_error": "Failed to confirm receipt",
    "shipping.select_condition": "Select product condition",
    "carriers.smsa": "SMSA Express",
    "carriers.aramex": "Aramex",
    "carriers.fedex": "FedEx",
    "carriers.dhl": "DHL",
    "carriers.ups": "UPS",
    "carriers.naqel": "Naqel Express",
    "carriers.zajil": "Zajil Express",
    ...
    // Admin Products on Shelves
    "admin.productsOnShelves.title": "Products on Shelves",
    "admin.productsOnShelves.description": "View all active products displayed on shelves",
    "admin.productsOnShelves.exportCSV": "Export CSV",
    "admin.productsOnShelves.filters": "Filters",
    "admin.productsOnShelves.search": "Search",
    "admin.productsOnShelves.searchPlaceholder": "Search by product, store, or brand...",
    "admin.productsOnShelves.filterByStore": "Filter by Store",
    "admin.productsOnShelves.filterByBrand": "Filter by Brand",
    "admin.productsOnShelves.filterByExpiry": "Filter by Expiry",
    "admin.productsOnShelves.expiring3Days": "Expiring in 3 days",
    "admin.productsOnShelves.expiring7Days": "Expiring in 7 days",
    "admin.productsOnShelves.expiring30Days": "Expiring in 30 days",
    "admin.productsOnShelves.showing": "Showing",
    "admin.productsOnShelves.products": "products",
    "admin.productsOnShelves.noProducts": "No products found",
    "admin.productsOnShelves.noProductsDescription": "There are no active products on shelves at the moment",
    "admin.productsOnShelves.productName": "Product Name",
    "admin.productsOnShelves.brand": "Brand",
    "admin.productsOnShelves.store": "Store",
    "admin.productsOnShelves.branch": "Branch",
    "admin.productsOnShelves.initialQty": "Initial Qty",
    "admin.productsOnShelves.soldQty": "Sold Qty",
    "admin.productsOnShelves.remainingQty": "Remaining Qty",
    "admin.productsOnShelves.rentalEndDate": "Rental End Date",
    "admin.productsOnShelves.daysUntilExpiry": "Days Until Expiry",
    "admin.productsOnShelves.expired": "Expired",
    ...
    "settings.brand_data.business_type": "Business Type",
    ...
    "settings.brand_data.profile_locked_title": "Profile Protected",
    "settings.brand_data.profile_locked_description": "Your core business data is protected and cannot be modified. To make changes, please contact support.",
    "settings.profile_locked_error": "Cannot modify data. Profile is protected. Please contact support to make changes.",
    "settings.locked_at_100": "Your profile is protected at 100% completion",
    "settings.complete_remaining": "Complete remaining fields to protect your profile",
    "settings.field_already_saved.name": "Name is already saved and cannot be modified",
    "settings.field_already_saved.email": "Email is already saved and cannot be modified",
    "settings.field_already_saved.phone": "Phone number is already saved and cannot be modified",
    "settings.field_already_saved.image": "Image is already saved and cannot be modified",
    "settings.field_already_saved.brandName": "Brand name is already saved and cannot be modified",
    "settings.field_already_saved.storeName": "Store name is already saved and cannot be modified",
    "settings.field_already_saved.businessCategory": "Business category is already saved and cannot be modified",
    "settings.field_already_saved.businessType": "Business type is already saved and cannot be modified",
    "settings.field_already_saved.commercialRegisterNumber": "Commercial register number is already saved and cannot be modified",
    "settings.field_already_saved.commercialRegisterDocument": "Commercial register document is already saved and cannot be modified",
    "settings.field_already_saved.freelanceLicenseNumber": "Freelance license number is already saved and cannot be modified",
    "settings.field_already_saved.freelanceLicenseDocument": "Freelance license document is already saved and cannot be modified",
    "settings.field_already_saved.website": "Website is already saved and cannot be modified",
    ...
    "settings.brand_data.freelance_license": "Freelance License Number",
    "settings.brand_data.freelance_license_document": "Freelance License Document File",
    ...
    // Stores Section (Landing Page)
    "landing.stores_title": "For Store Owners Benefit from every space you have... Share its details with us and expand your income",
    "landing.stores_description": "Because every inch is an opportunity, invest your available space and share it as points of sale, tell us about your place and provide us with its information and earn additional profit with ease.",
    ...
    "orders.brand_owner": "Brand Owner",
    ...
    "brand.dashboard.confirm_delete_product_description": "This product will be permanently deleted. This action cannot be undone.",
    ...
    // Status/State Values - Additional
    "status.pending_admin_approval": "Awaiting Admin Approval",
    ...
    // Clearances (B3.1)
    "clearances.title": "Clearances",
    "clearances.description": "Manage post-rental clearances and settlements",
    "clearances.empty": "No clearances found",
    "clearances.noResults": "No clearances match your search",
    "clearances.searchPlaceholder": "Search by store name...",
    "clearances.viewDetails": "View Details",
    "clearances.page": "Page",
    "clearances.of": "of",

    // Clearances - Stats
    "clearances.stats.total": "Total Clearances",
    "clearances.stats.active": "Active",
    "clearances.stats.closed": "Closed",
    "clearances.stats.revenue": "Total Revenue",

    // Clearances - Filters
    "clearances.filter.all": "All",
    "clearances.filter.active": "Active",
    "clearances.filter.closed": "Closed",

    // Clearances - Table
    "clearances.table.rentalId": "Rental ID",
    "clearances.table.store": "Store",
    "clearances.table.period": "Period",
    "clearances.table.status": "Status",
    "clearances.table.settlement": "Settlement",
    "clearances.table.actions": "Actions",

    // Clearances - Status
    "clearances.status.unknown": "Unknown",
    "clearances.status.not_started": "Not Started",
    "clearances.status.pending_inventory_check": "Pending Inventory",
    "clearances.status.pending_return_shipment": "Awaiting Return",
    "clearances.status.return_shipped": "Return Shipped",
    "clearances.status.return_received": "Return Received",
    "clearances.status.pending_settlement": "Settlement Pending",
    "clearances.status.settlement_approved": "Settlement Approved",
    "clearances.status.payment_completed": "Payment Complete",
    "clearances.status.closed": "Closed",

    // Clearances - Inventory
    "clearances.inventory.title": "Inventory Reconciliation",
    "clearances.inventory.empty": "No inventory data available",
    "clearances.inventory.product": "Product",
    "clearances.inventory.initial": "Initial",
    "clearances.inventory.sold": "Sold",
    "clearances.inventory.remaining": "Remaining",
    "clearances.inventory.salesValue": "Sales Value (incl. VAT)",
    "clearances.inventory.totals": "Totals",

    // Clearances - Settlement
    "clearances.settlement.title": "Financial Settlement",
    "clearances.settlement.notCalculated": "Settlement not yet calculated",
    "clearances.settlement.totalSales": "Total Sales (pre-tax)",
    "clearances.settlement.vat": "VAT",
    "clearances.settlement.totalWithTax": "Total with VAT",
    "clearances.settlement.commissions": "Commissions",
    "clearances.settlement.platformCommission": "Platform Commission",
    "clearances.settlement.storeCommission": "Store Commission",
    "clearances.settlement.brandRevenue": "Brand Revenue",
    "clearances.settlement.salesRevenue": "Sales Revenue",
    "clearances.settlement.returnInventory": "Returned Inventory",
    "clearances.settlement.returnedUnits": "Returned Units",
    "clearances.settlement.units": "units",
    "clearances.settlement.returnValue": "Return Value",
    "clearances.settlement.totalBrandAmount": "Total Brand Amount",
    "clearances.settlement.note": "Amount includes sales revenue minus commissions",

    // Clearances - Return Receipt
    "clearances.returnReceipt.title": "Confirm Return Receipt",
    "clearances.returnReceipt.description": "Confirm that you have received the returned products",
    "clearances.returnReceipt.condition": "Product Condition",
    "clearances.returnReceipt.selectCondition": "Select condition",
    "clearances.returnReceipt.conditionGood": "Good",
    "clearances.returnReceipt.conditionDamaged": "Damaged",
    "clearances.returnReceipt.conditionPartial": "Partial",
    "clearances.returnReceipt.notes": "Notes",
    "clearances.returnReceipt.notesPlaceholder": "Any additional notes about the returned products...",
    "clearances.returnReceipt.confirm": "Confirm Receipt",
    "clearances.returnReceipt.conditionRequired": "Please select product condition",
    "clearances.returnReceipt.success": "Return receipt confirmed successfully",
    "clearances.returnReceipt.error": "Failed to confirm return receipt",

    // Clearances - Return Shipping
    "clearances.returnShipping.title": "Return Shipping",
    "clearances.returnShipping.notShipped": "Products not yet shipped back by store",
    "clearances.returnShipping.received": "Received",
    "clearances.returnShipping.inTransit": "In Transit",
    "clearances.returnShipping.carrier": "Carrier",
    "clearances.returnShipping.trackingNumber": "Tracking Number",
    "clearances.returnShipping.shippedDate": "Shipped Date",
    "clearances.returnShipping.expectedDelivery": "Expected Delivery",
    "clearances.returnShipping.storeNotes": "Store Notes",
    "clearances.returnShipping.receiptConfirmed": "Receipt Confirmed",
    "clearances.returnShipping.receivedDate": "Received Date",
    "clearances.returnShipping.condition": "Condition",
    "clearances.returnShipping.confirmationNotes": "Confirmation Notes",

    // Clearances - Document
    "clearances.document.title": "Clearance Document",
    "clearances.document.description": "Download the complete clearance document",
    "clearances.document.ready": "Document is ready for download",
    "clearances.document.download": "Download Document",
    "clearances.document.notReady": "Document will be generated once clearance is complete",
    "clearances.document.notGenerated": "Document not yet generated",
    "clearances.document.downloadSuccess": "Document downloaded successfully",
    "clearances.document.downloadError": "Failed to download document",

    // Clearances - Details Page
    "clearances.details.title": "Clearance Details",
    "clearances.details.subtitle": "Clearance for rental",
    "clearances.details.rentalSummary": "Rental Summary",
    "clearances.details.rentalPeriod": "Rental Period",
    "clearances.details.rentalCost": "Monthly Cost",
    "clearances.details.totalPaid": "Total Paid",

    // Clearances - Quick Info (B3.4)
    "clearances.quickInfo.title": "Clearance",
    "clearances.quickInfo.settlement": "Settlement Amount",
    "clearances.quickInfo.payout": "Your Payout",
    "clearances.quickInfo.viewDetails": "View Full Clearance",

    // Clearances - Store Specific (B3.2)
    "clearances.store.description": "Track clearances and receive commission payouts",
    "clearances.store.stats.pendingPayouts": "Pending Payouts",
    "clearances.store.stats.completedPayouts": "Completed Payouts",
    "clearances.store.searchPlaceholder": "Search by brand name...",
    "clearances.store.table.brand": "Brand",
    "clearances.store.table.payout": "Payout",
    "clearances.payout.title": "Your Commission Payout",
    "clearances.payout.storeCommission": "Your Commission",
    "clearances.payout.commissionRate": "Commission Rate",
    "clearances.payout.platformCommission": "Platform Commission",
    "clearances.payout.totalPayout": "Total Payout",
    "clearances.payout.note": "Payment will be transferred to your registered bank account",
    "clearances.storeReturnShipping.title": "Ship Return to Brand",
    "clearances.storeReturnShipping.description": "Ship unsold products back to the brand",
    "clearances.storeReturnShipping.notesPlaceholder": "Any notes about the return shipment...",
    "clearances.storeReturnShipping.submit": "Submit Shipment",
    "clearances.storeReturnShipping.success": "Return shipment submitted successfully",
    "clearances.storeReturnShipping.error": "Failed to submit return shipment",
    "clearances.payoutTracker.title": "Payout Status",
    "clearances.payoutTracker.noPayments": "No payment records yet",
    "clearances.payoutTracker.completed": "Completed",
    "clearances.payoutTracker.processing": "Processing",
    "clearances.payoutTracker.failed": "Failed",
    "clearances.payoutTracker.pending": "Pending",
    "clearances.payoutTracker.payoutAmount": "Payout Amount",
    "clearances.payoutTracker.createdDate": "Created",
    "clearances.payoutTracker.completedDate": "Completed",
    "clearances.payoutTracker.viewDetails": "View breakdown",
    "clearances.payoutTracker.netPayout": "Net Payout",
    "clearances.payoutTracker.pendingNote": "Pending transfers typically complete within 3-5 business days",

    // Clearances - Admin Specific (B3.3)
    "clearances.admin.title": "Clearance Management",
    "clearances.admin.description": "Oversee all clearances, approve settlements, and manage payouts",
    "clearances.admin.stats.pendingApproval": "Pending Approval",
    "clearances.admin.stats.completed": "Completed",
    "clearances.admin.stats.salesVolume": "Total Sales Volume",
    "clearances.admin.filter.status": "Filter by Status",
    "clearances.admin.filter.pendingApprovalOnly": "Show only pending approval",
    "clearances.admin.searchPlaceholder": "Search by brand or store name...",
    "clearances.admin.table.brandStore": "Brand → Store",
    "clearances.admin.table.settlement": "Settlement Breakdown",
    "clearances.admin.needsApproval": "Needs Approval",
    "clearances.admin.platform": "Platform",
    "clearances.admin.store": "Store",
    "clearances.admin.brand": "Brand",
    "clearances.admin.details.title": "Admin Clearance Overview",
    "clearances.admin.initialShipping": "Initial Shipping (Brand → Store)",
    "clearances.approval.title": "Settlement Approval",
    "clearances.approval.description": "Review and approve the calculated settlement",
    "clearances.approval.pending": "Pending Approval",
    "clearances.approval.approved": "Approved",
    "clearances.approval.approvedOn": "Approved on",
    "clearances.approval.platformCommission": "Platform Commission",
    "clearances.approval.storePayout": "Store Payout",
    "clearances.approval.brandRevenue": "Brand Revenue",
    "clearances.approval.totalSales": "Total Sales",
    "clearances.approval.approve": "Approve Settlement",
    "clearances.approval.confirmTitle": "Approve Settlement?",
    "clearances.approval.confirmDescription": "This will approve the settlement calculation and trigger store payout:",
    "clearances.approval.success": "Settlement approved successfully",
    "clearances.approval.error": "Failed to approve settlement",
    "clearances.receiptUpload.title": "Payment Transfer Receipt",
    "clearances.receiptUpload.description": "Upload proof of transfer to store",
    "clearances.receiptUpload.file": "Receipt File",
    "clearances.receiptUpload.notes": "Reference Notes",
    "clearances.receiptUpload.notesPlaceholder": "Transfer reference number or notes...",
    "clearances.receiptUpload.upload": "Upload Receipt",
    "clearances.receiptUpload.uploaded": "Uploaded",
    "clearances.receiptUpload.view": "View Receipt",
    "clearances.receiptUpload.fileRequired": "Please select a file",
    "clearances.receiptUpload.invalidFileType": "Only PDF and image files are allowed",
    "clearances.receiptUpload.fileTooLarge": "File size must be less than 5MB",
    "clearances.receiptUpload.success": "Receipt uploaded successfully",
    "clearances.receiptUpload.error": "Failed to upload receipt",
    "clearances.statusManagement.title": "Manual Status Override",
    "clearances.statusManagement.warning": "⚠️ Use with caution - Manual overrides bypass normal workflow",
    "clearances.statusManagement.currentStatus": "Current Status",
    "clearances.statusManagement.newStatus": "New Status",
    "clearances.statusManagement.selectStatus": "Select new status",
    "clearances.statusManagement.reason": "Reason for Override",
    "clearances.statusManagement.reasonPlaceholder": "Why is this manual change needed?",
    "clearances.statusManagement.notes": "Additional Notes",
    "clearances.statusManagement.notesPlaceholder": "Any additional context...",
    "clearances.statusManagement.updateStatus": "Update Status",
    "clearances.statusManagement.confirmTitle": "Confirm Manual Status Change",
    "clearances.statusManagement.confirmDescription": "Are you sure you want to manually change the status?",
    "clearances.statusManagement.from": "From",
    "clearances.statusManagement.to": "To",
    "clearances.statusManagement.reasonRequired": "Please provide a reason for the status change",
    "clearances.statusManagement.success": "Status updated successfully",
    "clearances.statusManagement.error": "Failed to update status",
  },
}
...
export function LanguageProvider({
  ...
  const t = (key: string, params?: Record<string, string | number>): string => {
    ...
    // Replace placeholders like {name}, {count}, etc. with actual values
    if (params) {
